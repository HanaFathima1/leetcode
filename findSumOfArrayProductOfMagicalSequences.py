...
LC: 3539. Find Sum of Array Product of Magical Sequences
...
sol = Solution()
print(sol.magicalSum(m = 5, k = 5, nums = [1,10,100,10000,1000000]))
print(sol.magicalSum(m = 2, k = 2, nums = [5,4,3,2,1]))
print(sol.magicalSum(m = 1, k = 1, nums = [28]))